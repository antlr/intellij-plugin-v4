...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        outerPanel.setLayout(new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1));
        splitPane = new JSplitPane();
        splitPane.setDividerLocation(191);
        splitPane.setDividerSize(9);
        outerPanel.add(splitPane, new GridConstraints(0, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(800, 400), null, 0, false));
        ...
        label5.setText("Number of tokens:");
        ...
        statsPanel.add(numTokensField, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
    ...
    public void setProfilerData(Parser parser,
        ...
        parseTimeField.setText(String.valueOf((long) (parseTime_ns / (1000.0 * 1000.0))));
        predictionTimeField.setText(String.valueOf((int) (parseInfo.getTotalTimeInPrediction() / (1000.0 * 1000.0))));
        int numTokens = parser.getInputStream().size();
        numTokensField.setText(String.valueOf(numTokens));
        double look = getTotalLookaheadOps(parseInfo.getDecisionInfo());
        lookaheadBurdenField.setText(
                String.format("%d/%d = %3.2f", (long) look, numTokens, look / numTokens)
        );
        double atnLook = getTotalATNLookaheadOps(parseInfo.getDecisionInfo());
        cacheMissRateField.setText(
                String.format("%d/%d = %3.2f%%", (long) atnLook, (long) look, atnLook * 100.0 / look)
        );
    }

    public long getTotalLookaheadOps(DecisionInfo[] decisions) {
        long k = 0;
    ...
    public long getTotalATNLookaheadOps(DecisionInfo[] decisions) {
        long k = 0;
        for (int i = 0; i < decisions.length; i++) {
